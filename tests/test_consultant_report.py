...
class TestConsultantReportStructure(unittest.TestCase):
    ...
    def test_has_all_expected_sections(self):
        for section in (
            ...
            "## Key Risks",
            "## Security Controls",
            "## Experimental Process-Evidence Classification",
            "## Top Remediations",
            "## Evidence Appendix",
            "## Limitations",
        ):
...
class TestConsultantReportContent(unittest.TestCase):
    def test_high_risk_and_readiness_both_shown_independently(self):
        ...
        self.assertIn("experimental severity label being **High**", md)
        self.assertIn("Level 1 — Baseline", md)
        self.assertIn("independent heuristic outputs", md)
    ...
    def test_no_ai_repo_terminates_early(self):
        ...
        self.assertNotIn("## Experimental Process-Evidence Classification", md)
